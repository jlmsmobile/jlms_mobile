		...
		jlms.fileSystem.root.getDirectory( jlms.consts.DIR_IMAGES, {create: false}, function(dir) {
			...
			$(data).each( function(i, el) {		
				...
				{				
					...
					html += '<li><a class="external-links" href="iframe.html" data-href="'+link+'" ><img src="'+src+'" class="ui-li-thumb" /><span style="top: 35%; position: absolute;">'+el.name+'<font style="background-color: red; color: white; padding: 3px 5px; margin-left: 3px;">'+rand+'</font></span></a></li>';															
				}
			});		
			html += '</ul>';
